...
<head>
    ...
    <title>CV - KAYEYE MUKWA Godefroid | Développeur Fullstack</title>
                            ...
                            <div>
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center text-gray-500 mb-2">
                                    <span class="flex items-center">
                                        ...
                                        <span class="mr-4">Université Pédagogique Nationale</span>
                                    </span>
                                    <span class="flex items-center">
                                        <i class="fas fa-calendar-alt mr-1 text-blue-500"></i>
                                        <span>2019 - 2025</span>
                        ...
                        <div class="relative pl-10 timeline-item">
                            ...
                            <div>
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center text-gray-500 mb-2">
                                    <span class="flex items-center">
                                        <i class="fas fa-university mr-1 text-blue-500"></i>
                                        <span class="mr-4">Collège des Savoirs</span>
                                    </span>
                                    <span class="flex items-center">
                                        <i class="fas fa-calendar-alt mr-1 text-blue-500"></i>
                                        <span>2017 - 2018</span>
        ...
        <footer class="mt-12 bg-white rounded-xl shadow-md p-6 text-center">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="mb-4 md:mb-0">
                    <p class="text-gray-600">© 2025 Kayeye Godefroid - Tous droits réservés</p>
                </div>
                <div class="flex space-x-4">
                    <a href="tel:+243835370927" class="flex items-center text-blue-500 hover:text-blue-600">
                        <i class="fas fa-phone mr-2"></i> +243 835 370 927
                    </a>
                    <a href="mailto:godetkayeye07@gmail.com" class="flex items-center text-blue-500 hover:text-blue-600">
                        <i class="fas fa-envelope mr-2"></i> godetkayeye07@gmail.com
                    </a>
                </div>
            </div>
        </footer>
